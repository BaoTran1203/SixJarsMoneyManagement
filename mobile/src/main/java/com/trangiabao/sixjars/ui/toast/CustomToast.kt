package com.trangiabao.sixjars.ui.toast
...
class CustomToast(private var context: Context,
    ...
    class Builder(private var context: Context, private var activity: Activity) {
        ...
        fun show() = CustomToast(context, activity, type, message, icon, duration).show()
    }
}